...
console.log(
    `Sarah's dog eats too ${sarahDog.curFood > sarahDog.recFood ? 'much' : 'little'}`,
);
...
const dogsGroupdByNumberOfOwners = Object.groupBy(
    dogs,
    dog => dog.owners.length,
);

console.log(dogsGroupdByNumberOfOwners);
